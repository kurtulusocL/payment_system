...
namespace PaymentSystem.Infrastructure.Data.Context.Azure
{
    public class AzureDbContext : IdentityDbContext<AppUser, AppRole, string>
    {
        ...
        public AzureDbContext(DbContextOptions<AzureDbContext> options, IEncryptionService encryptionService) : base(options) 
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ConfigureDbContexts(converter, includeLocalEntities: false);
        }
    }
}
